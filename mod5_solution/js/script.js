...
// Crea HTML para la página de inicio según la matriz de categorías
...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    false); // Aquí es falso porque solo obtenemos HTML normal del servidor, por lo que no es necesario procesar JSON.
}
